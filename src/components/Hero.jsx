    ...
    <div className="max-w-6xl mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-36 min-h-[85vh] w-full">
      <div className="text-left space-y-6 max-w-xl animate-fade-in">
        ...
        <div className="flex gap-4 flex-wrap items-center">
          ...
          <a href={resolveAssetPath(resumeUrl)} download="Sheena_U_Resume.pdf" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full font-semibold text-sm cursor-pointer transition-all duration-200 border border-border-color bg-transparent text-text-primary hover:bg-bg-tertiary hover:border-text-secondary hover:-translate-y-1">
